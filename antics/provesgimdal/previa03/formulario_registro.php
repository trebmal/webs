    ...
    <?php
        ...
        if(isset($_POST['registrar'])){             
           ...
           // $nuevoUsuario = new Usuario($_POST['usuario'],$_POST['nombre'],$_POST['apellidos'],$_POST['email'],$_POST['edad'],$_POST['telefono'],$_POST['password'],$_POST['password2']);
            $nuevoUsuario = new Usuario($_POST['usuario'],$_POST['nombre'],$_POST['apellidos'],$_POST['password'],$_POST['password2']);
        ...
        <div id="formulario_registro">
            ...
            <form action="#" method=POST>
                <div class="campoFormulario">
                    ...
                    <input type='text' id="usuario" name="usuario" maxlength="19" value="<?php echo $usuario ?>" onblur="return validarNombreUsuario(this.value)" autocomplete="off"/>
                </div>
                <div class="campoFormulario">
